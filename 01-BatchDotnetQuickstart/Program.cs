...
namespace BatchDotNetQuickstart
{
    public class Program
    {
        ...
        private const string BatchAccountName = "testbatchac20200617";
        private const string BatchAccountKey = "f45DIYX9Aq6/rxM0oH3r4t1fvO2QSkFh9p2rkMmAu0esTBGsvE7bychLsLVZk7DIz9kaIdDPxGTcI56qp0ZyhQ==";
        private const string BatchAccountUrl = "https://testbatchac20200617.eastus2.batch.azure.com";

        // Storage account credentials
        private const string StorageAccountName = "testbatchsa20200617";
        private const string StorageAccountKey = "lzRLL7taCALosqW6J6rLAxwjdKfARTwzzxHOArHbMkxfNBjG8h2Y4a6tJpTNobZt1HngvniXfC4trL1UWKerhg==";

        // Batch resource settings
        private const string PoolId = "newDotNetQuickstartPool";
        private const string JobId = "newDotNetQuickstartJob";
            ...
            try
            {
                ...
                using (BatchClient batchClient = BatchClient.Open(cred))
                {
                    ...
                    for (int i = 0; i < inputFiles.Count; i++)
                    {
                        ...
                        string taskCommandLine = String.Format("cmd /c copy {0}", inputFilename);
